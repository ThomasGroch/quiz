...
if ( ! function_exists('day_hour_to_ISO8601'))
{
  /**
...
if ( ! function_exists('transform_datetime'))
{
  /**
...
if ( ! function_exists('brazilian_datetime'))
{
  /**
...
if ( ! function_exists('brazilian_date_explode'))
{
  /**
...
if ( ! function_exists('brazilian_date_compare'))
{
  /**
