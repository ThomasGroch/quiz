...
<html lang="en">
    ...
    <head>
        ...
        <title>Sistema de Pesquisas</title>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?= base_url('admin/dashboard') ?>">Sistema de Pesquisas v1.0</a>
                </div>
                <!-- /.navbar-header -->
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            <?php /* <li><a href="#"><i class="fa fa-user fa-fw"></i> User Profile</a></li>*/ ?>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="<?= base_url('admin/questions') ?>"><i class="fa fa-edit fa-fw"></i> Perguntas</a>
                            </li>
                            <li>
                                <a href="<?= base_url('admin/results') ?>"><i class="fa fa-list-alt"></i> Resultados</a>
                            </li>
                        </ul>
                    </div>
                    <!-- /.sidebar-collapse -->
                    ...
                    <div class="col-lg-12 text-center" style="">
                        <a href="http://algroch.com/" alt="Desenvolvimento de sistemas para internet Curitiba" target="_blank"><img src="http://algroch.com/logos/algroch-logo2.png" style="width: 50%; margin-top:50px;" /></a>
                    </div>
                </div>
                <!-- /.navbar-static-side -->
